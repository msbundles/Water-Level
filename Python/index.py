import requests
fRom = input("What is the day and time you would like to get data from? (YYYYMMDD HR:MN) ")
to = input("What is the day and time you would like to get data to? (YYYYMMDD HR:MN) ")
